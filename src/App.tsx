    ...
    <>
      ...
      <div>
        <div className="flex items-center mb-4">
            <input id="default-checkbox" type="checkbox" value="" className="shrink-0 peer checked:bg-green appearance-none border border-green mr-2 w-4 h-4 accent-green focus:ring-green dark:focus:ring-green dark:ring-green focus:ring-2 dark:bg-green dark:border-green">
            </input>
